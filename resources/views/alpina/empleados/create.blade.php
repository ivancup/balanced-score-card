...
@section('content')
    @component('admin.components.panel')
        @slot('title', 'Crear Empleado')
        {!! Form::open([
            'route' => 'admin.empleados.store',
            'method' => 'POST',
            'id' => 'form_crear_empleado',
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
                ...
                {!! Form::submit('Crear Empleado', ['class' => 'btn btn-success']) !!}
            </div>
        </div>
        {!! Form::close() !!}
    @endcomponent
            ...
            form.submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response, NULL, jqXHR) {
                        ...
                        $(form)[0].reset();
                        $("#area").select2('data', {}); // clear out values selected
                        $("#area").select2({allowClear: true});
