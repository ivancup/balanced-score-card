{{-- Titulo de la pagina --}} 
@section('title', 'Reporte Area') {{-- Contenido principal --}} 
@extends('admin.layouts.app') 
@section('content')
    @component('admin.components.panel') 
        @slot('title', 'Reporte Area.')


        <div class="row">
        <form action="{{ route('admin.reporte.areas.formulario') }}" method="post" id="form_selecionar_area">
            @csrf
